...
\item We obtain from (B)
\begin{align}
    \dot R^2&=\frac{8\pi}{3}G\varrho R^2+\frac{1}{3}\Lambda R^2-K\\
    &\rightarrow \varrho=\frac{3}{8\pi GR^2}\left(\dot R^2-\frac{1}{3}\Lambda R^2+K\right)\\
    &\rightarrow \varrho=\frac{3}{8\pi G}\left(\frac{\dot R^2}{R^2}-\frac{1}{3}\Lambda +\frac{K}{R^2}\right)
\end{align}
and from (A)
\begin{align}
    \frac{\ddot R}{R}&=-\frac{4\pi G}{3}(\varrho+3p)+\frac{1}{3}\Lambda
\end{align}
from (C) we have
\begin{align}
    R^3\dot\varrho+ 3R^2\dot R\varrho+3R^2\dot Rp=0\\
    \dot\varrho+ 3\frac{\dot R}{R}(\varrho+p)=0\\
    \dot\varrho+ 3\frac{\dot R}{R}\varrho(1+k\varrho^{\gamma-1})=0\\
\end{align}

and with $p=k\varrho^\gamma$ ($K$ is already in use) we have
\begin{align}
    \varrho+3p=\varrho+3k\varrho^\gamma
\end{align}
\end{enumerate}
