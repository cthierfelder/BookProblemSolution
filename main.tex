...
\begin{align}
    \nabla\cdot\vec{\mathcal{E}}&=\partial_a(E_a\vec{e}^a)e^{-i(\omega t -\vec{k}\vec{x})}+\partial_a(e^{-i(\omega t -\vec{k}\vec{x})})E_a\vec{e}^a\\
    &=\left[\partial_aE_a+\delta_{ab}ik_bE_a\right]e^{-i(\omega t -\vec{k}\vec{x})}\vec{e}^a\\
    &=\left[\partial_aE_a+ik_bE_b\right]e^{-i(\omega t -\vec{k}\vec{x})}\vec{e}^a\\
    &=0
\end{align}
...
\item $\nabla\times\vec{E}=i\frac{\partial\mathcal{E}}{\partial t}$
\end{enumerate}
