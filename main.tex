...
\begin{align}
    \int\delta(x)e^{-ikx}dx=1\quad\leftrightarrow\quad\frac{1}{2\pi}\int e^{ikx}dk=\delta(x)
\end{align}
...
\begin{align}
    ...
    G(\vec{x})&=\frac{1}{(2\pi)^3}\int d^3\vec{k} \frac{e^{i\vec{k}\vec{x}}}{k^2+\mathcal{R}^{-2}}\\
    &=\frac{1}{(2\pi)^3}2\pi\int_0^\infty \int_{-\pi/2}^{-\pi/2} \frac{e^{ik_r\cdot x\cos(\theta)}}{k_r^2+\mathcal{R}^{-2}}k_r^2\sin(\theta) d\theta dk_r\\
    &=\frac{1}{(2\pi)^3}2\pi\int_0^\infty \int_{-\pi/2}^{-\pi/2} \frac{e^{ik_r\cdot x\cos(\theta)}}{k_r^2+\mathcal{R}^{-2}}k_r^2\sin(\theta) d\theta dk_r\\
\end{align}
