...
\begin{align}
    ...
    &=z|z\rangle
\end{align}
\item With $a^\dagger|n\rangle=\sqrt{n+1}|n+1\rangle$
\begin{align}
...
\begin{align}
    \Delta p\Delta q
    &=\sqrt{\left(\frac{\langle z|p^2|z\rangle}{\langle z|z\rangle}-\frac{(\langle z|p|z\rangle)^2}{(\langle z|z\rangle)^2}\right)
    \left(\frac{\langle z|q^2|z\rangle}{\langle z|z\rangle}-\frac{(\langle z|q|z\rangle)^2}{(\langle z|z\rangle)^2}\right)}
\end{align}
\end{enumerate}
