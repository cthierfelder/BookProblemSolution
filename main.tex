...
Finite dimensional irreps of the Lorentz group are labeled by $(\mu,\nu)$ with
\begin{align}
    \mu,\nu &\in \{0,\frac{1}{2},1,\frac{3}{2},2,...\}.
\end{align}
...
\begin{center}
 ...
 $(1,1)$                        & 9 & 0,1,2 & traceless symmetric $2^\text{nd}$ rank tensor \\  [0.5ex]
 $(\frac{1}{2},0)\oplus(0,\frac{1}{2})$& - & - & Dirac bispinor $\psi^\alpha\quad \alpha\in\{1,2,3,4\}$ \\  [0.5ex]
 $(1,\frac{1}{2})\oplus(\frac{1}{2},1)$& - & - & Rarita-Schwinger field $\psi^\alpha\quad \alpha\in\{1,2,3,4\}$ \\  [0.5ex]
  $(0,1)\oplus(0,1)$& - & - & parity invariant field of 2-forms\\  [0.5ex]
\end{tabular}
\end{center}
