...
\begin{align}
    ...
    &=\lim_{N\rightarrow\infty}\left(\frac{m}{2\pi i\delta t}\right)^\frac{N+1}{2}e^{\frac{im}{2\delta t}(q_N^2+q_0^2)}\int_{-\infty}^{\infty}\left(\prod_{j=1}^N dq_j\right)\,e^{\frac{im}{2\delta t}\left(-2q_1q_0+\sum_{k=1}^N2q_k^2-2q_{k+1}q_{k}\right)}\\
    &=\lim_{N\rightarrow\infty}\left(\frac{m}{2\pi i\delta t}\right)^\frac{N+1}{2}e^{\frac{im}{2\delta t}(q_N^2+q_0^2)}\int_{-\infty}^{\infty}\left(\prod_{j=2}^N dq_j\right)\,e^{\frac{im}{2\delta t}\left(\sum_{k=2}^N2q_k^2-2q_{k+1}q_{k}\right)}\\
    &\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\times\int_{-\infty}^{\infty}dq_1\,e^{\frac{im}{2\delta t}\left(2q_1^2-2[q_{2}-q_0]q_1\right)}
\end{align}
Using again
\begin{align}
    \int_{-\infty}^\infty dx e^{-ax^2+bx+c}=\sqrt{\frac{\pi}{a}}e^{\frac{b^2}{4a}+c}
