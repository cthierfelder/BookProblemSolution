...
\subsubsection*{Problem 1.2.4 - Properties of Callan-Coleman-Jackiw energy-momentum tensor}
...
\subsubsection*{Problem 1.2.6 - O(N) invariance of action of $n$ free scalar fields}
...
\subsubsection*{Problem 1.3.4 - Feynman rules of $\phi^4$ theory}
\textcolor{red}{Not done yet}
